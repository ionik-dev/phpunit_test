...
class CalcultatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    /** @test */
    public function operations_are_ignored_if_not_instance_of_OperationInterface()
    {
        $addition = new \App\Calculator\Addition;
        $addition->setOperands([5, 10]);

        $calculator = new \App\Calculator\Calculator;
        $calculator->setOperations([$addition, 'wrong_operation']);
